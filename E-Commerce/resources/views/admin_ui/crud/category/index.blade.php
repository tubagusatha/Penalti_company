                              ...
                              @foreach($category as $c)
                                ...
                                <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                    ...
                                    <td class="p-4 space-x-2 whitespace-nowrap">
                                      ...
                                      <form action="{{url("admin_panel/category/$c->id")}}" method="POST">
                                      @csrf
                                      @method('DELETE')
...
<script>
  ...
  deleteForms.forEach(function(form) {
      form.addEventListener('submit', function(event) {
          ...
          var actionUrl = '/admin_panel/category/' + productId;
...
<div id="drawer-disabled-backdrop" class="fixed top-0 right-0 z-40 w-full h-screen max-w-xs p-4 overflow-y-auto transition-transform translate-x-full bg-white dark:bg-gray-800" tabindex="-1" aria-labelledby="drawer-disabled-backdrop-label" aria-hidden="true">
    <h5 id="drawer-disabled-backdrop-label" class="inline-flex items-center mb-6 text-sm font-semibold text-gray-500 uppercase dark:text-gray-400">New Category</h5>
   ...
   <form action="{{ url('/admin_panel/category/create') }}" method="POST" enctype="multipart/form-data">
    @csrf
    <div class="space-y-4">
        <div>
            <label for="name_category" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Name</label>
