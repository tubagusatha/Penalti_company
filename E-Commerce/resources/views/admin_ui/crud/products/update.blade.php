  ...
  <main>
    <div class="p-4 bg-white block sm:flex items-center justify-between border-b border-gray-200 lg:mt-1.5 dark:bg-gray-800 dark:border-gray-700" style="margin-top: 1.5rem">
              ...
              <nav class="flex mb-5" aria-label="Breadcrumb">
                  <ol class="inline-flex items-center space-x-1 text-sm font-medium md:space-x-2">
                    ...
                    <li>
                      <div class="flex items-center">
                        <svg class="w-6 h-6 text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path></svg>
                        <a href="#" class="ml-1 text-gray-700 hover:text-primary-600 md:ml-2 dark:text-gray-300 dark:hover:text-white">Edit Product</a>
                      </div>
                    </li>
                  </ol>
              </nav>
      ...
      <div class=" px-3 py-3 dark:bg-gray-800 dark:border-gray-700">
        <form action="{{ url('admin_panel/product/' . $product->id ) }}" method="POST">
          @csrf
          @method('PATCH')
        <label for="name_products" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Product Name</label>
                <input type="text" name="name_products" id="name_products" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" value="{{ old('name_products') ?? $product->name_products}}" placeholder="Type product name" required="">
    </div>
      <div class=" px-3 py-3 dark:bg-gray-800 dark:border-gray-700">
...
<div class=" px-3 py-3 dark:bg-gray-800 dark:border-gray-700">
  ...
  <label class="inline-flex items-center cursor-pointer">
    <input type="checkbox" value="1" name="show_products" class="sr-only peer" {{ $product->show_products ? 'checked' : '' }}>
    ...
    <div class="bottom-0 left-0 flex justify-center w-full space-x-4 md:px-4 py-5 dark:bg-gray-800 dark:border-gray-700">
